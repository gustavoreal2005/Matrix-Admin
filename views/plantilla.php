...
<body>
    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full" data-sidebar-position="absolute" data-header-position="absolute" data-boxed-layout="full">
        ...
        if (isset($_GET["ruta"])) {
            if ($_GET["ruta"] == "inicio" || $_GET["ruta"] == "categoria" || $_GET["ruta"] == "usuarios" || $_GET["ruta"] == "productos" || $_GET["ruta"] == "salir") {
    ...
    <script>
        $(document).ready(function() {
            $('#miTabla').DataTable({
                "language": {
                    "url": "//cdn.datatables.net/plug-ins/9dcbecd42ad/i18n/Spanish.json" // Cambia a español
                }
            });
        });
    </script>
